...
function M.find_ufovim_files(opts)
  opts = opts or {}
  ...
  local theme_opts = themes.get_ivy {
    ...
    prompt = ">> ",
    prompt_title = "~ ufovim files ~",
    cwd = utils.join_paths(get_runtime_dir(), "ufovim"),
...
function M.grep_ufovim_files(opts)
  opts = opts or {}
  local themes = require "telescope.themes"
  local theme_opts = themes.get_ivy {
    sorting_strategy = "ascending",
...
function M.view_ufovim_changelog()
...
function M.setup()
  ...
  if ufovim.builtin.telescope.on_config_done then
    ufovim.builtin.telescope.on_config_done(telescope)
  end
end
