...
function M.setup(config)
  ...
  theme.base = { -- luacheck: ignore
    ...
    CursorColumn = {bg = c.fg_dark}, -- Screen-column at the cursor, when 'cursorcolumn' is set.
    CursorLine = {bg = c.fg_dark}, -- Screen-line at the cursor, when 'cursorline' is set.  Low-priority if foreground (ctermfg OR guifg) is not set.
  ...
  theme.plugins = {
    ...
    DashboardCenter = {fg = c.blue, style = "bold"},
